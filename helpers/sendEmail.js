...
const sendEmail= async ({email, userId, username, userType}) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Click <a href="https://intern-connect-frontend-three.vercel.app/reset-password?token=${hashedToken}&userType=${userType}">here</a> to reset your password or copy and paste the below link in your browser,
                <br>https://intern-connect-frontend-three.vercel.app/reset-password?token=${hashedToken}&userType=${userType}</p> `
        };
